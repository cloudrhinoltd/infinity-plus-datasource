  ...
  return (
    <div>
      <Stack gap={1} alignItems="center">
        <LinkButton size="sm" variant="primary" href="https://grafana.com/docs/plugins/infinity-plus-datasource" target="_blank" rel="noreferrer">
          Plugin Docs
        </LinkButton>
        ...
        <LinkButton size="sm" variant="secondary" fill="outline" href="https://grafana.com/docs/plugins/infinity-plus-datasource/latest/csv" target="_blank" rel="noreferrer">
          CSV
        </LinkButton>
        <LinkButton size="sm" variant="secondary" fill="outline" href="https://grafana.com/docs/plugins/infinity-plus-datasource/latest/xml" target="_blank" rel="noreferrer">
          XML
        </LinkButton>
        <LinkButton size="sm" variant="secondary" fill="outline" href="https://grafana.com/docs/plugins/infinity-plus-datasource/latest/query/uql" target="_blank" rel="noreferrer">
          UQL
        </LinkButton>
        <LinkButton size="sm" variant="secondary" fill="outline" href="https://grafana.com/docs/plugins/infinity-plus-datasource/latest/setup/authentication" target="_blank" rel="noreferrer">
          Authentication
        </LinkButton>
        <LinkButton size="sm" variant="secondary" fill="outline" href="https://github.com/cloudrhinoltd/infinity-plus-datasource/discussions/categories/show-and-tell" target="_blank" rel="noreferrer">
          Examples &amp; Tutorials
        </LinkButton>
        <LinkButton size="sm" variant="secondary" fill="outline" href="https://github.com/cloudrhinoltd/infinity-plus-datasource/discussions/categories/specific-apis" target="_blank" rel="noreferrer">
          API Specific Question
        </LinkButton>
        <LinkButton size="sm" variant="secondary" fill="outline" href="https://github.com/cloudrhinoltd/infinity-plus-datasource/discussions/categories/q-a" target="_blank" rel="noreferrer">
          More Questions?
        </LinkButton>
      </Stack>
      {activeTab && (
        ...
        },
        {
            ...
            <br />
            <LinkButton variant="primary" style={{ margin: '10px' }} href="https://grafana.com/docs/plugins/infinity-plus-datasource/latest/json" target="_blank" rel="noreferrer">
              Need more help?
            </LinkButton>
          </div>
        </Modal>
