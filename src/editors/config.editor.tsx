...
export const MainEditor = (props: DataSourcePluginOptionsEditorProps<InfinityOptions> & { setActiveTab: React.Dispatch<React.SetStateAction<string>> }) => {
  ...
  return (
    <div
      style={{
        backgroundImage: theme.isDark ? 'url(/public/plugins/infinity-plus-datasource/img/homepage-bg.svg)' : '',
    ...
    >
      <h1>👋 Welcome to InfinityPlus Data Source!</h1>
      ...
      <div style={{ marginBlockStart: 5 }}>
        ...
        <LinkButton
          ...
          size="md"
          target="_blank"
          href="https://cloudrhino.netlify.app/docs/infinityplus"
          rel="noreferrer"
